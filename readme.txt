...
statistical operations on (in the folder 'testfiles' are already a few files you can use).
The File must have one header-line and valid values otherwise statistical calculations
are not possible by this program.
